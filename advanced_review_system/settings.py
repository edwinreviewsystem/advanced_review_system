"""
Django settings for advanced_review_system project.
...
ROOT_URLCONF = 'advanced_review_system.urls'
...
WSGI_APPLICATION = 'advanced_review_system.wsgi.application'
...
SIMPLE_JWT = {
    ...
    # for blacklisting old refresh token
